 ...
 */
final class Version20250508050142 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE comments (id SERIAL NOT NULL, post_id INT NOT NULL, comment TEXT NOT NULL, title VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))
        SQL);
        $this->addSql(<<<'SQL'
